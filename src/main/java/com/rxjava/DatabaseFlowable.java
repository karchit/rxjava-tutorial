...
import com.rxjava.nitrite.dataaccess.FibonacciNumberDataAccess;
import com.rxjava.nitrite.datasets.NitriteFibonacciSequenceSchema;
...
public class DatabaseFlowable {

    private final static Logger log = LoggerFactory.getLogger(DatabaseFlowable.class);
